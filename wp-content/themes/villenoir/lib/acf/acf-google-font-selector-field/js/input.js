			...
			acf.get_fields({ type : 'google_font_selector'}, $el).each(function(){
                ...
                jQuery(document).on( 'change', '.acfgfs-font-family select', function(){
                    ...
                    jQuery.ajax({
                        ...
                        data: {
                            action: 'villenoir_get_font_details',
                ...
                jQuery(document).on( 'change', '.acfgfs-font-family select', function(){
                    ...
                    jQuery.ajax({
                        ...
                        success: function( response ) {
							...
							font = new_font.replace( ' ', '+' );
							container.find('.acfgfs-preview').html('<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=' + font + '"><div style="font-family:' + new_font + '">This is new a preview of the selected font</div>')
