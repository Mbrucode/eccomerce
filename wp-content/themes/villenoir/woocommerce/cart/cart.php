...
<table class="shop_table shop_table_responsive cart col-md-12" cellspacing="0">
	<thead>
		<tr>
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<td class="product-thumbnail">
						<?php
							$thumbnail = apply_filters( 'woocommerce_cart_item_thumbnail', $_product->get_image(array(9999,300)), $cart_item, $cart_item_key );
					...
					<td class="product-subtotal" data-title="<?php esc_html_e( 'Total', 'woocommerce' ); ?>">
						<?php
				...
				<?php if ( wc_coupons_enabled() ) { ?>
					<div class="coupon">
						<div class="input-group">
							...
							<input type="text" name="coupon_code" class="input-text form-control" id="coupon_code" value="" placeholder="" />
