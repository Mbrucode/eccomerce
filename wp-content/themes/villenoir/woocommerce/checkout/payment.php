	...
	<div class="form-row place-order">
	 ...
	 <div class="bs-example">
          <div class="alert alert-warning">
            <h4><strong style="color:#8A6D3B">Delivery Conditions</strong></h4>
			<div style="padding-left:16px;">
		    <li><h4> 11am-12pm midnight Monday to Sunday  </h4></li>
            <li><h4> Last delivery order 11:15pm  </h4></li>
            <li><h4> We aim to deliver your drinks within 45-60min </h4></li>
			</div>
          </div>
    </div>
