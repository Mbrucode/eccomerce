...
Merchants can also accept donations via credit cards or PayPal. By enabling webhooks, you can receive on demand information about the status of your orders. Worldpay is the UK's lagest payment provider. They have years of experience providing payment solutions that meet the demands
...
- Accept donations using credit cards or Paypal (short code [worldpay_donations])
...
save a template form, a template code will be generated. The template code is used in the plugin to identify which form you want to be used on your donation and checkout pages. 
Since the form is hosted by Worldpay, no payment information touches your server making it a SAQ A PCI compliant solution.

= Where can I get a license for this plugin = 
You can purchase a license by visiting https://wordpress.paymentplugins.com. We offer  a basic and pro plan. The basic plan has all functionality included but limited support. 
The Pro plan guarantees you priority support for all of your integration questions. 
...
You can place a donation form on any page that you desire. Simply type in the short code [worldpay_donations] on the page that you want to receive 
donations. 
...
= 1.1.1 =
* Changed - license activation url changed. 
= 1.1.0 = 
