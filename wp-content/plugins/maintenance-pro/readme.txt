...
* Improvements: Changed maintenance hook add_meta_boxes to add_mt_metaboxes
* Bug fix: Campaign Monitor conflict (duplicated libs)
* Bug fix: Changed filter for pop up section

= 3.2 = (25.11.2016)

* Improvements: Video sounds new logic
* Improvements: Get icons from CDN's
* Bug fix: Extended scroll and display social icons
* Bug fix: Enter site button
* Bug fix: Close icon fix

= 3.1.1 = (21.09.2016)

* Bug fix: HTML pop up "read me" button in one row
