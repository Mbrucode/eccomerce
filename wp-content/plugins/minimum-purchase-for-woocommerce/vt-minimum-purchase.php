...
class VTMIN_Controller{
	...
	public function __construct(){    
		...
		define('VTMIN_VERSION',                               '1.09.8');
    define('VTMIN_MINIMUM_PRO_VERSION',                   '1.08.3'); 
    define('VTMIN_LAST_UPDATE_DATE',                      '2017-04-03');
 ...
 *************************************************** */
    ...
    if ($use_clear_cart_msgs) {
      ...
      if (strpos($currPageURL,$woo_cart_url )     !== false) {
