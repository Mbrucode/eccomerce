...
class VTMIN_Checkbox_classes{
  ...
  /*
      function function vtmin_build_checkbox_contents migrated to rules-ui, to allow for easy alteration in freemium model.
  */
     
    /*
    * For the checkbox tax_type, get all the selected values and return in checked_list
    */
    public function vtmin_produce_tax_checked_list ($post_ID, $taxonomy) { 
    ...
    */
    public function vtmin_process_tax_checklist ($post_ID, $taxonomy) { 
        $checked_list = wp_get_object_terms($post_ID, $taxonomy, array('fields'=>'ids'));
        return $checked_list;
    }
   ...
   */
    ...
    */
    public function vtmin_process_roles_checklist () { 
    ...
    */
    ...
    public function vtmin_is_user_in_role_list ($checked_list) { 
        if ( !is_user_logged_in() ) {
            return false;
        }
        if (strpos($checked_list, vtmin_get_current_user_role() )) {   //if role is in previously checked_list
          return true;
        } else { 
          return false;
        }
