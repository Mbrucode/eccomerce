...
// Parent container
vc_map( array(
    'name'                    => esc_html__( 'Timeline Item' , 'villenoir-shortcodes' ),
    'base'                    => 'timeline_item',
    'icon'                    => 'icon-wpb-row',
    "icon"                    => "gg_vc_icon",
    "weight"                  => -50,
    ...
    'params'                  => array(
                ...
                array(
                      "type" => "dropdown",
                      "heading" => esc_html__("Timeline style", "villenoir-shortcodes"),
                      "param_name" => "timeline_style",
                      "value" => array(esc_html__("Horizontal", "villenoir-shortcodes") => "horizontal", esc_html__("Vertical", "villenoir-shortcodes") => "vertical"),
                      "description" => esc_html__("Choose the timeline style", "villenoir-shortcodes")
                ),
...
// Nested Element
vc_map( array(
    'name'            => esc_html__('Timeline Items', 'villenoir-shortcodes'),
    ...
    'params'          => array(
                ...
                array(
                    "type" => "textfield",
                    "heading" => esc_html__("Date","villenoir-shortcodes"),
                    "param_name" => "date",
                    "admin_label" => true,
                    "description" => esc_html__("Insert the date/year here","villenoir-shortcodes")
                ),
                array(
                    "type" => "textfield",
