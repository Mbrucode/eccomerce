...
vc_map( array(
   "name"              => esc_html__("Posts grid","villenoir-shortcodes"),
   "description"       => esc_html__('Display grid posts.', 'villenoir-shortcodes'),
   "base"              => "posts_grid",
   "icon"              => "gg_vc_icon",
   "weight"            => -50,
   ...
   "params" => array(
      array(
        ...
        "value" => array(
            esc_html__("Grid Fit rows", "villenoir-shortcodes") => "fitRows", 
            esc_html__('Grid Masonry', "villenoir-shortcodes")  => 'masonry', 
            esc_html__('Carousel', "villenoir-shortcodes")      => 'carousel'
          ),
        "description" => esc_html__("Layout template.", "villenoir-shortcodes")
      ),
      array(
        "type" => "dropdown",
        "heading" => esc_html__("Layout style", "villenoir-shortcodes"),
        "param_name" => "grid_layout_style",
        "value" => array(
            esc_html__("Default (with image)", "villenoir-shortcodes")    => "default", 
            esc_html__("Default (without image)", "villenoir-shortcodes") => "default_no_img", 
            esc_html__('Overlay', "villenoir-shortcodes")                 => 'overlay'
          ),
        "description" => esc_html__("Post style.", "villenoir-shortcodes")
      ),
      //Carousel options
      array(
          "type" => "dropdown",
          "heading" => esc_html__("Slides per view", "villenoir-shortcodes"),
          "param_name" => "slides_per_view",
          "value" => array(1, 2, 3, 4),
          "description" => esc_html__("Set numbers of slides you want to display at the same time on slider's container for carousel mode.", "villenoir-shortcodes"),
      ...
      array(
         ...
         "value" => '9',
         "description" => esc_html__("Insert the number of posts to display. Default: 9","villenoir-shortcodes")
      ),
      array(
           "type" => "checkbox",
           "heading" => esc_html__("Display category filter?","villenoir-shortcodes"),
           "value" => array(esc_html__("Display category filter","villenoir-shortcodes") => "use_category_filter" ),
      ...
      array(
         "type" => "gg_taxonomy",
         "taxonomy" => "category",
         "heading" => esc_html__("Posts grid terms", "villenoir-shortcodes"),
         "param_name" => "posts_grid_terms",
         "description" => esc_html__("Select posts_grid terms to display. By default it displays posts from all terms.", "villenoir-shortcodes"),
      ...
      array(
         "type" => "dropdown",
         "heading" => esc_html__("Order way", "villenoir-shortcodes"),
         "param_name" => "order",
         "value" => array(
            "Descending" => "desc",
            "Ascending" => "asc"
