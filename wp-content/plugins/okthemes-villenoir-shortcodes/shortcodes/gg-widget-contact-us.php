...
vc_map( array(
   "name"              => esc_html__("Widget: Contact us", "villenoir-shortcodes"),
   "description"       => esc_html__('Display address, phone, fax, email', 'villenoir-shortcodes'),
   ...
   "params" => array(
      ...
      array(
         "type" => "textarea",
         "heading" => esc_html__("Address", "villenoir-shortcodes"),
         "param_name" => "address",
         "admin_label" => true,
         "description" => esc_html__("Insert address here", "villenoir-shortcodes")
      ),
      array(
         "type" => "textfield",
         "heading" => esc_html__("Phone", "villenoir-shortcodes"),
         "param_name" => "phone",
         "description" => esc_html__("Insert phone here", "villenoir-shortcodes")
      ),
      array(
         "type" => "textfield",
         "heading" => esc_html__("Fax", "villenoir-shortcodes"),
         "param_name" => "fax",
         "description" => esc_html__("Insert fax here", "villenoir-shortcodes")
      ),
      array(
         "type" => "textfield",
         "heading" => esc_html__("Email", "villenoir-shortcodes"),
         "param_name" => "email",
         "description" => esc_html__("Insert email here", "villenoir-shortcodes")
      ),
      array(
         "type" => "textfield",
