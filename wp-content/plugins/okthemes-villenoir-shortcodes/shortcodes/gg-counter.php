...
vc_map( array(
   "name"              => esc_html__("Counter","villenoir-shortcodes"),
   "description"       => esc_html__('A counter from 0 to a specified number.', 'villenoir-shortcodes'),
   "base"              => "counter",
   "icon"              => "gg_vc_icon",
   "weight"            => -50,
   ...
   "params" => array(
	  ...
	  array(
		"type" => "textfield",
		"heading" => esc_html__("Number", "villenoir-shortcodes"),
		"param_name" => "number"
	  ),
	  array(
		"type" => "colorpicker",
		"heading" => esc_html__("Number color", "villenoir-shortcodes"),
		"param_name" => "font_color",
		"dependency" => Array('element' => "number", 'not_empty' => true)
	  ),
	  array(
		"type" => "textfield",
		"heading" => esc_html__("Number font size (px)", "villenoir-shortcodes"),
	  ...
	  array(
		 ...
		 "value" => array(esc_html__("Use an icon for your counter.","villenoir-shortcodes") => "use_icon" ),
		 "param_name" => "add_icon"
	  ),
	  array(
		'type' => 'dropdown',
	  ...
	  array(
		'type' => 'dropdown',
		'heading' => esc_html__( 'Size', 'villenoir-shortcodes' ),
		'param_name' => 'size',
		'value' => array(
		  esc_html__( 'Small', 'villenoir-shortcodes' ) => 'sm',
		  esc_html__( 'Normal', 'villenoir-shortcodes' ) => 'md',
		  esc_html__( 'Large', 'villenoir-shortcodes' ) => 'lg',
		  esc_html__( 'Extra Large', 'villenoir-shortcodes' ) => 'xl',
		),
		'std' => 'md',
		'description' => esc_html__( 'Icon size.', 'villenoir-shortcodes' ),
		"dependency" => Array('element' => "add_icon", 'value' => array('use_icon'))
	  ),
	  array(
		"type" => "colorpicker",
		"heading" => esc_html__("Icon color","villenoir-shortcodes"),
		"param_name" => "icon_color",
		"dependency" => Array('element' => "add_icon", 'value' => array('use_icon'))
	  ),
	  array(
		 "type" => "checkbox",
		 "heading" => esc_html__("Box?","villenoir-shortcodes"),
		 "value" => array(esc_html__("Display the counter in a box","villenoir-shortcodes") => "use_box" ),
		 "param_name" => "add_box"
	  ),
	  array(
		"type" => "colorpicker",
		"heading" => esc_html__("Box background","villenoir-shortcodes"),
		"param_name" => "box_background",
		"description" => esc_html__("Choose your background color.", "villenoir-shortcodes"),
		"dependency" => Array('element' => "add_box", 'value' => array('use_box'))
	  ),
	  array(
		  "type" => "textfield",
		  "heading" => esc_html__('Box Padding', 'villenoir-shortcodes'),
		  "param_name" => "padding",
	  ...
	  array(
		"type" => "textfield",
		"heading" => esc_html__("Refresh interval", "villenoir-shortcodes"),
		"param_name" => "interval",
		"value" => '100'
	  ),
	  array(
		"type" => "textfield",
		"heading" => esc_html__("Speed", "villenoir-shortcodes"),
		"param_name" => "speed",
		"value" => '1500'
	  ),
	  array(
