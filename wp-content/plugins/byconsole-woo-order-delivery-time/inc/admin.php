...
function byconsolewooodt_add_plugin_menu(){
...

	{
		...
		?>
			...
			<li><?php echo __('27) Get location on map and customer can pick a location dorectly from map(with map add-on plugin).','byconsole-woo-order-delivery-time');?></li>
            ...
            <li><?php echo __('29) Get customized/more extended copy to suit your all needs(may be paid).','byconsole-woo-order-delivery-time');?></li>
...
function byconsolewooodt_plugin_settings_fields()
	...
	add_settings_field("byconsolewooodt_takeaway_lable", "Pickup lable text:", "byconsolewooodt_takeaway_lable", "byconsolewooodt_plugin_options", "section");	
	
	add_settings_field("byconsolewooodt_delivery_lable", "Delivery lable text:", "byconsolewooodt_delivery_lable", "byconsolewooodt_plugin_options", "section");
	
	add_settings_field("byconsolewooodt_date_field_text", "Date field text:", "byconsolewooodt_date_field_text", "byconsolewooodt_plugin_options", "section");
	
	add_settings_field("byconsolewooodt_time_field_text", "Time field text:", "byconsolewooodt_time_field_text", "byconsolewooodt_plugin_options", "section");	
